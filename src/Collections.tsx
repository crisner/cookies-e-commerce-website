...
const Collections = (props: CollectionsProps): JSX.Element => (
  <section className="collections">
    ...
    <CollectionsItem img="../public/images/home-cookie-01.png" 
    alt="Sugar free cookies" 
    title="Yummy sugar free cookies" 
    width="425px" />
    <CollectionsItem img="../public/images/home-cookie-02.png" 
    alt="Keto cookies" 
    title="Keto friendly cookies" 
    width="425px" />
    <CollectionsItem img="../public/images/home-cookie-03.png" 
    alt="Millet cookies" 
